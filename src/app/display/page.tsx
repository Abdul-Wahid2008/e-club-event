    ...
    <div className="min-h-screen flex flex-col overflow-hidden">
      ...
      <header className="flex items-center justify-between px-6 sm:px-10 py-5">
        <div className="flex items-center gap-3">
          <Image src="/logo-icon-optimized.png" alt="" width={36} height={36} className="w-9 h-9 rounded-lg object-contain" priority />
        ...
        <AnimatePresence mode="wait">
          {eventState?.results_revealed ? (
            ...
            >
              ...
              <Image src="/logo-icon-optimized.png" alt="The Pitch League" width={120} height={120} className="w-24 h-24 sm:w-32 sm:h-32 mx-auto object-contain relative" priority />
