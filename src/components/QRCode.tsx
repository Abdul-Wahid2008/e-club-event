...
interface QRCodeProps {
  ...
  size?: number;
  className?: string;
  /** Foreground module color. Defaults to near-black for max scan contrast against the white quiet zone. */
  fg?: string;
  bg?: string;
}
 ...
 * happens in src/lib/qrcode.ts (vendored MIT-licensed algorithm). Rendered
 * on a solid white background regardless of theme, since QR scanners need
 * hard black-on-white contrast, not dark-mode tokens.
 */
